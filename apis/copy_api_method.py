...
def insertCustomer():
    val_list = [("ABSLi","active"),("ABMF","active")]
...
def customerUsageDetails(data_dict = {}):
    ...
    for (sub, month_year) in itertools.product(*[subs, month_list]):
        ...
        collection_name  = "1c10f9a928c74c6789209efb6bd0a8b2_1_2023"
    ...
    print(dict1, db_str_mongo, collection_name)
    hhh
...
if __name__ == '__main__':
    data_dict = {
    "subscriptions": [
        "1c10f9a9-28c7-4c67-8920-9efb6bd0a8b2"
    ],
    "regions": [
        "centralindia"
    ],
    ...
    "date": [
        "2022-12-25T00:00:00.0000000Z",
        "2023-1-1T00:00:00.0000000Z"
    ],
    "filter": []
}
    print(customerUsageDetails(data_dict))
    pass
