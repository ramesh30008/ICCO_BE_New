...
def getResCostByDateAndRes(data_dict):
    ...
    resource_clicked = data_dict['rname']
    ...
    cust_data = mongo_methods.get_resCost_date(db_str_mongo, collection_name, date_, sid, rg_to_hp_dict, resource_clicked)
...
def getCustomerResFilterData(data_dict):
...
def customerResUsageDetails(data_dict = {}):
