...
if __name__ == '__main__':
    #data_dict = {"date":["2022-11-23","2022-11-18" ], "hostpools":["4302-MLI-1","4261-MHE-42"], "regions":["eastus"],"tags":[], "subscriptions":["bb953f35-22e7-431c-a6c3-fa44e577c5bc"]}
    ...
    data_dict = {
    "hostpool": "4261-MHE-42",
    "date": "2022-11-22"
}
    #print(getCostByDateAndHostpool(data_dict))
    #print(getCostByDateAndSid(data_dict))
    data_dict = {"cust_id":1, "date": ["2022-11-18", "2022-11-25"], "hostpools": ["4261-MHE-42","4261-MLI-1","4261-MME-41","4261-MNX-2","4261-MQY-40","4261-PCT-36","4261-SHB-5","4261-SPO-43","4261-SQO-44","4261-SYY-4","4278-MLI-1","4278-SCT-36","4278-SPO-43","4279-SYY-4","4286-MLI-1","4286-SYY-4","4289-MME-41","4289-SPO-43","4292-MNX-2","4295-M24-83","4295-MBS-84","4296-MNX-2","4297-MSY-85","4298-MNX-2","4298-MTW-3","4299-MHE-42","4299-MHH-86","4299-MLI-1","4299-MTW-3","4301-MLI-1","4301-MNX-2","4302-MLI-1","4302-MMX-89","4302-MNX-2","4303-MHE-42","4303-MTW-3","4304-MTW-3"], "subscriptions": [], "regions":["eastus"]}
    #getHostpoolCostBydate(data_dict) 
    data_dict = {"key": "c6c5fe58-d0d1-44b2-9196-12a024713aca",     "currentPage": 2, "rowsCountPerTable": 10, "sort_order": 0, "column_id": 1}
    #print (getHostpoolCostBydate_TP(data_dict))
    print (getHostpoolCostBydate_TP_Sort(data_dict))
