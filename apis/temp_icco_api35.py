...
def DesktopCostHistory(data_dict):
    ...
    #ndata_dict = Tobj.storeData({"txkeys": xkeys, "tykeys": ["Total"]+list(tykeys_p.keys()),"tdata": tdata_p})
    #ntxkeys = ndata_dict["txkeys"]
    #ntykeys = ndata_dict["tykeys"]
    #ntdata = ndata_dict["tdata"]
    #return {"pooled":{"txkeys": ntxkeys, "tykeys": ntykeys, "tdata": ntdata, "gdata": gdata_final_p, "gxkeys":gxkeys_p, "gykeys":gykeys_p}, "personal":{"txkeys":xkeys, "tykeys":["Total"]+list(tykeys.keys()),"tdata": tdata, "gdata": gdata_final, "gxkeys":gxkeys, "gykeys":gykeys, "key": ndata_dict["key"], "total_pages": ndata_dict["total_pages"], "records": ndata_dict["records"]}}
...
if __name__ == '__main__':
    ...
    data_dict = {"hostpools":["4261-MHE-42","4261-MLI-1","4261-MME-41","4261-MNX-2","4261-MQY-40","4261-PCT-36","4261-SHB-5","4261-SPO-43","4261-SQO-44","4261-SYY-4","4278-MLI-1","4278-SCT-36","4278-SPO-43","4279-SYY-4","4286-MLI-1","4286-SYY-4","4289-MME-41","4289-SPO-43","4292-MNX-2","4295-M24-83","4295-MBS-84","4296-MNX-2","4297-MSY-85","4298-MNX-2","4298-MTW-3","4299-MHE-42","4299-MHH-86","4299-MLI-1","4299-MTW-3","4301-MLI-1","4301-MNX-2","4302-MLI-1","4302-MMX-89","4302-MNX-2","4303-MHE-42","4303-MTW-3","4304-MTW-3","4306-MTW-3","4307-SYY-4","4307-MLT-5","4301-MTW-3","4307-GPU-6","4307-NV8-07","4307-MNE-91","4307-MXM-93"],"subscriptions":["bb953f35-22e7-431c-a6c3-fa44e577c5bc"],"regions":["eastus"],"tags":[],"date":["2022-12-14T00:00:00.0000000Z","2022-12-21T00:00:00.0000000Z"],"cust_id":1,"cust_name":"Anunta Dev","rproviders":["Microsoft.DesktopVirtualization"]}
